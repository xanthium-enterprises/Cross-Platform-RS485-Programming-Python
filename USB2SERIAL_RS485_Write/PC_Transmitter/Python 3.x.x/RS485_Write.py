#----------------------------------------------------------------------------------------------------#
# RS485 Communication using Python (Write) (hardware = USB2SERIAL)  (Python 3.x)                     #
#----------------------------------------------------------------------------------------------------#
...
#====================================================================================================#
# Interpreter/IDE  : Python 3.x/IDLE     	                                                         #
# Module           : PySerial                                                                        #                                                                                                    #
...
#    USB2SERIAL will be listed as ttyUSB*(eg ttyUSB0,or ttyUSB1)                                     #
#                                                                                                    #
# You can also connect your USB2SERIAL to PC USB port and use "dmesg |tail" to find out the name of- # 
